...
Gate A was approved on 2026-09-08 (Asia/Shanghai) in `GYT-45`. The approval evidence is member comment `01a07e3a-141c-71ac-b30b-0f06cf0c4a8b`, followed by the recorded gate decision in `01a07e3d-5a77-7972-a9cd-360c9d41dc84`. It authorizes repository implementation and offline verification only. Gate B/Gate C progression authorization was later recorded in `GYT-47` comment `01a07fcd-9140-7aa7-b05a-83485a7ed8c7`. Successor `5672c2a147e8975ac0de218fa0605ce83882aadf` received independent GO, after which GYT-47 was marked terminal `done` and Stage 3 ran from evidence HEAD `dd1277b86d04ed3a5d2cabe41c558d6de9049c09`. Those historical states were invalidated when Stage 4 rejected HEAD `b231ef4507e4003d2a5d3fe3a25ec1d659d7cb75`. The remediated exact candidate `0cd9b31fc3f3a35dc404f6bafe8af8f87dc66ca2` has now received three independent GO verdicts; GYT-47 awaits human acceptance, while GYT-48 and GYT-52 remain in `backlog`. Production execution remains blocked until GYT-47 is accepted, Stage 3 is rerun and accepted, the exact Gate B packet is reviewed, and Gate C records its catch-up choice after Gate B evidence acceptance.
...
The shared worktree is not an implementation baseline because it contains unrelated tracked and untracked changes. GYT-47 therefore used isolated branches/worktrees rooted in recorded clean baselines. Earlier Stage 2 successor `5672c2a147e8975ac0de218fa0605ce83882aadf` received three independent GO verdicts and produced Stage 3 baseline `dd1277b86d04ed3a5d2cabe41c558d6de9049c09`, but Stage 4 later rejected `b231ef4507e4003d2a5d3fe3a25ec1d659d7cb75`; subsequent intermediate remediation candidates were also rejected. Final fourth-successor candidate `0cd9b31fc3f3a35dc404f6bafe8af8f87dc66ca2` remains rooted at that exact Stage 4 baseline on the isolated `agent/backend/gyt-47-stage4-release-safety` branch and received three independent GO verdicts. If implementation requires a new external configuration/API contract not stated in these approved artifacts, work stops and returns for architecture review.
...
M1 and M2 are one backend implementation stage because the documentation baseline had to be completed before its first code edit. M3 was historically promoted after the implementation stage became terminal and reviewed, but Stage 4 NO-GO invalidated that acceptance; remediated M2 has now received independent GO and awaits issue acceptance, while M3 remains backlogged. Tasks 4.x onward are not assigned in this Gate A plan.
...
2. M1/M2 historically completed on an isolated reviewed clean worktree with evidence HEAD `dd1277b86d04ed3a5d2cabe41c558d6de9049c09`; Stage 4 later invalidated that acceptance, and remediated M2 exact candidate `0cd9b31fc3f3a35dc404f6bafe8af8f87dc66ca2` has now received three independent GO verdicts.
3. M3 was historically promoted from that completion evidence, then returned to `backlog` after Stage 4 NO-GO; it must not restart until GYT-47 is accepted and the reviewed exact candidate becomes its new baseline.
